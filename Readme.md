...
4) Настройте «Samples» для плотности интерполяции.
...
- `src/interp.rs` — линейная интерполяция и структуры данных.
- `src/export.rs` — экспорт CSV и XLSX.
- `src/config.rs` — стили/скорости и загрузка конфигурации TOML.

## Дорожная карта

- [ ] Дополнительные интерполяции: сплайны, сглаживание, аппроксимация.
