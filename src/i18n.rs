...
pub enum TextKey {
    ...
    ImageLimitsIntro,
    SourceImageInfo,
    ConfiguredLimitsInfo,
    HardLimitsInfo,
    SuggestedAutoscaleInfo,
    RejectLoad,
    AutoscaleToFit,
    IgnoreLimits,
    ActionUnavailable,
...
impl TextKey {
    ...
    pub const ALL: [Self; 267] = [
        ...
        Self::ContinueAnyway,
        Self::Cancel,
        Self::ImageLimitsWindow,
        Self::ImageLimitsIntro,
        Self::SourceImageInfo,
        Self::ConfiguredLimitsInfo,
        Self::HardLimitsInfo,
        Self::SuggestedAutoscaleInfo,
        Self::RejectLoad,
        Self::AutoscaleToFit,
        Self::IgnoreLimits,
...
const fn en_text(key: TextKey) -> &'static str {
    match key {
        ...
        TextKey::ImageLimitsWindow => "Image limits",
        TextKey::ImageLimitsIntro => "Image exceeds configured limits. Choose how to proceed:",
        TextKey::SourceImageInfo => "Source image",
        TextKey::ConfiguredLimitsInfo => "Configured limits",
        TextKey::HardLimitsInfo => "Hard safety limits",
        TextKey::SuggestedAutoscaleInfo => "Suggested autoscale",
        TextKey::RejectLoad => "Reject load",
        TextKey::AutoscaleToFit => "Autoscale to fit",
        TextKey::IgnoreLimits => "Ignore limits",
        TextKey::ActionUnavailable => "Action unavailable",
...
const fn ru_text(key: TextKey) -> Option<&'static str> {
    match key {
        ...
        TextKey::ImageLimitsWindow => Some("Лимиты изображения"),
        TextKey::ImageLimitsIntro => {
            Some("Изображение превышает настроенные лимиты. Выберите действие:")
        }
        TextKey::SourceImageInfo => Some("Исходное изображение"),
        TextKey::ConfiguredLimitsInfo => Some("Настроенные лимиты"),
        TextKey::HardLimitsInfo => Some("Жёсткие защитные лимиты"),
        TextKey::SuggestedAutoscaleInfo => Some("Рекомендованный автоскейл"),
        TextKey::RejectLoad => Some("Отклонить загрузку"),
        TextKey::AutoscaleToFit => Some("Автоскейл до лимитов"),
        TextKey::IgnoreLimits => Some("Игнорировать лимиты"),
        TextKey::ActionUnavailable => Some("Действие недоступно"),
